# image-logger
a discord image logger that gets user ip, customizable, renders image, renders troll gif when user opens it in browser, generates a fake token and is hosted on replit.
